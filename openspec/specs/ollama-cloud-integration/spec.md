# ollama-cloud-integration Specification

## Purpose

Defines the built-in `ollama-cloud` provider profile for the hosted Ollama Cloud
API using the standard Chat Completions adapter and Bearer API-key
